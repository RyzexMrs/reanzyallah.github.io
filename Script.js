...
<div class="ui inverted segment">
  <div class="ui inverted form">
	...
	<div class="field" id="botname">
        <label>Name</label>
        <div class="ui large labeled input"><input type="text" value="${params.get('name') || "reanzyallah"}" placeholder="Nickname" maxlength="17" spellcheck="false" data-ms-editor="true"></div>
      </div>
      <div class="field">
        <label>Room</label>
    ...
    socket.addEventListener('message', (event) => {
      ...
      switch (data[0]) {
        case 5: {
          ...
          if (params.get('private-mode') !== "true") { socket.send(`42[11,"${playerId}"," reanzyallah"]`); }
